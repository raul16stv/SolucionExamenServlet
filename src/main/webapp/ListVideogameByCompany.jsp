...
<body>
<form action="ListVideogameCompany" method="post">
...
<form action="ListVideogameByCompany" method="post">
<input type="submit" value="show list"/>
	<table border="1">
		...
		<tbody>
			<c:forEach var="listAllVideogameByCompany" items="${listAllVideogameByCompany}">
				<tr>
					<td><c:out value="${listAllVideogameByCompany.name}"/> </td>
		    	</tr>
			</c:forEach>
		</tbody>
	</table>
